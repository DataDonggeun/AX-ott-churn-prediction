...
router = APIRouter(prefix="/09", tags=["09. 2×2 EDA"])
...
def eda_2x2(force: bool = False):
    ...
    save_json("step09_result", result)
    mark_done("step09", {"total_rows": result.get("total_rows")})
