...
def feature_engineering(
    mem_file: Annotated[str, Query(description="멤버십 파일명 (data/01_raw/ 기준)")] = "Membership_train.csv",
    vh_file: Annotated[str, Query(description="시청이력 파일명")] = "Views_train.csv",
    movie_file: Annotated[str, Query(description="영화 마스터 파일명")] = "Movies.csv",
    mapping_file: Annotated[str, Query(description="유저 매핑 파일명")] = "mapping.csv",
    test_mem_file: Annotated[str, Query(description="테스트 멤버십 파일명")] = "Membership_test.csv",
    test_vh_file: Annotated[str, Query(description="테스트 시청이력 파일명")] = "Views_test.csv",
):
    """
